...
<%!String JDBC_DRIVER = "com.mysql.jdbc.Driver";%>
   ...
   String from_week = request.getParameter("from_week");
   ...
   //out.println(from_month+" "+to_month);
        ...
        String sql="SELECT * FROM `sales` natural join vehicle natural join models natural join options where year(sale_date)>="+from_year+" and year(sale_date)<="+to_year+" and week(sale_date)>="+from_week+" and week(sale_date)<="+to_week+" "+extra_filter+";";
