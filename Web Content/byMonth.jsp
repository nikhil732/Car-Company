...
<%!String JDBC_DRIVER = "com.mysql.jdbc.Driver";%>
  ...
  // out.println(brand+dealer+body_type+engine_type+transmission+".<br>");
   //out.println(from_month+" "+to_month);
        ...
        String sql="SELECT * FROM `sales` natural join vehicle natural join models natural join options where month(sale_date)>="+from_month+" and month(sale_date)<="+to_month+" and year(sale_date)>="+from_year+" and year(sale_date)<="+to_year+" "+extra_filter+";";
