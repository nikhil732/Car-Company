...
h1{font-family:Verdana, sans-serif;font-size:90px;color:#000000;background-color:#fbfbfb;}
...
<form action="drop_down2.jsp">
	...
	<h2>Select Body Type: <select id="body_type" onclick="hideall1()" name="select_body_type">
	...
	<h2>Select Engine: <select id="engine" name="select_engine">
