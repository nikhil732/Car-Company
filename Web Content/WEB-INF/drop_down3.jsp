...
<style>
body {background-color:#c0dff7;background-repeat:no-repeat;background-position:top left;background-attachment:fixed;}
h1{font-family:Verdana, sans-serif;font-size:60px;color:#000000;background-color:#fbfbfb;padding: 20px;}
...
String sel = request.getParameter("select_brand");
	 ...
	 try
		{
		   ...
		   ps.setString(1,sel);
		    rs=ps.executeQuery();
		    PreparedStatement ps1=con.prepareStatement("select distinct body_type  from  models where model_name=?");
			   ps1.setString(1,sel);
			    rs1=ps1.executeQuery();
		    out.println("The Model_ID for your selected brand are :  " + "<br>");
		    while(rs.next())
			{
			String m_id=rs.getString("model_name");
			
			out.println(m_id +"<br>");				//session.putValue("model_id",m_id);
   ...
   %>
   <form action=choose_car1.jsp method="post"><center>
